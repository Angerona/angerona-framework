...
//		
		...
		if (param.getAtom() instanceof IslandPerception) {
			...
			param.report("Update-Operator: Can't handle perception of type: " + param.getAtom().getClass().getName());param.report("Update-Operator: Cant handle perception of type: " + param.getAtom().getClass().getName());
		}
