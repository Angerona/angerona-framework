...
public abstract class BaseVariable<T> implements Variable<T> {
	 ...
	 */
	public void setContent(String content) throws KReaturesException {
		if(instance != null || this.content != null) {
			throw new KReaturesException("setContent of BaseVariable was called " +
	 ...
	 * the KReatures Exception.
	 * @param content		The string acting as source for conversion.
	 * @return				An instance of type T which is represented 
	 * 						by the given string.
	 * @throws KReaturesException
	 */
	protected abstract T createInstanceFromString(String content) throws KReaturesException;
