...
/**
 * Static methods are used for generating unique ids for the KReatures Entity
 * hierarchy.
 * 
 ...
 * 
 * BEWARE: the id generation will be reseted after KReatures exits. This means when restarting
