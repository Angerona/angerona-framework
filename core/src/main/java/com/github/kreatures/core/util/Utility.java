...
public class Utility {
	...
	/**
	 * Returns the AnswerValue version of a lie, given the KReaturesAnswer containing the truth. Simply negates it. 
	 * @param truth
	...
	public static KReaturesAnswer lie(KReaturesAnswer truth) {
		KReaturesAnswer reval = new KReaturesAnswer(truth.getQueryFOL());
		reval.setAnswer(lie(reval.getAnswerValue()));
		return reval;
	}
	
	/**
	 * Returns the FolFormula version of a lie, wrapped in its own KReaturesAnswer. Not sure yet if it should just return the FolFormula.
