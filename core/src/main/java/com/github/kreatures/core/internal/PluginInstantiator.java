...
import com.github.kreatures.core.listener.PluginListener;
...
public class PluginInstantiator {
	...
	/**
	 * 	Loads the plugins for the core KReatures Framework and informs the listeners about the
	 ...
	 * @param plugin	The KReaturesPlugin having the list of class definitions
	 */
	 ...
	 * @param plugin	The KReaturesPlugin which shall be unregistered.
	 */
