...
import com.whiplash.config.BooleanConfigurationOption;
import com.whiplash.config.CharsetConfigurationOption;
import com.whiplash.config.ConfigurationCategory;
import com.whiplash.config.ConfigurationOption;
import com.whiplash.config.FileListQueueConfigurationOption;
import com.whiplash.config.FontConfigurationOption;
import com.whiplash.config.IntegerConfigurationOption;
import com.whiplash.config.WlConfiguration;
import com.whiplash.config.WlEditorPaneConfigurationOptions;
import com.whiplash.config.WlMteConfigurationOptions;
 ...
 */
public abstract class WhiplashEditorConfiguration {
	...
	public static void fillConfiguration(){
		...
		WlConfiguration.addConfigurationCategory(WhiplashEditorConfiguration.getGeneralConfig());
		WlConfiguration.addConfigurationCategory(WhiplashEditorConfiguration.getFontsAndColorsConfig());
		WlConfiguration.addConfigurationCategory(WhiplashEditorConfiguration.getTypesettingConfig());
	}
}
