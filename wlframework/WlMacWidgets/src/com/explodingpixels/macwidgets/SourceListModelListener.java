...
public interface SourceListModelListener {
    ...
    /**
     * Called when a top-level item is added. (ADDED BY MT)
     *
     * @param item 	   the item that was added.
     * @param index    the index at which the item was added.
     */
    void topLevelItemAdded(SourceListItem item, int index);

    /**
     * Called when a top-level item is removed. (ADDED BY MT)
     *
     * @param item the item that was removed.
     */
    void topLevelItemRemoved(SourceListItem item);
