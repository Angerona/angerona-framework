...
import com.github.kreatures.gui.util.tree.SortedTreeNode;
import com.github.kreatures.gui.util.tree.TreeCollectionMonitor;
import com.github.kreatures.gui.util.tree.TreeHelper;
...
public class ProjectTreeView extends ObservingPanel implements ProjectView {
	...
	@Override
	public void onProjectChange(KReaturesProject project) {
